...
namespace HordeForge.WasmHost.Registry
{
    ...
    /// module path must stay inside Mods/Wasm), no dot-only segments, and no
    /// control characters (C0, DEL, C1) that could forge log lines or drive
    /// terminals through the guest log and status output paths.
    /// </summary>
